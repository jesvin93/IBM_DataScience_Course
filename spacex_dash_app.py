...
def update_pie_chart(selected_site):
    if selected_site == 'ALL':
        # If ALL sites are selected, create a pie chart for all sites
        fig = px.pie(spacex_df, names='class', title='Success vs. Failure for All Sites')
    else:
        # If a specific launch site is selected, filter the data for that site and create a pie chart
...
def update_scatter_chart(selected_site, payload_range):
    if selected_site == 'ALL':
        # If ALL sites are selected, create a scatter plot for all data with payload and class
        ...
        # If a specific launch site is selected, filter the data for that site
        filtered_df = spacex_df[(spacex_df['Launch Site'] == selected_site) &
